...
class Application:
    def __init__(self):
        self.directory = 'C:/Users/Vikash/Desktop/Sign-Language-to-Text-master/model/'
        ...
        self.json_file = open(os.path.join(
            self.directory, "model-bw.json"), "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights(
            os.path.join(self.directory, "model-bw.h5"))

        self.json_file_dru = open(os.path.join(
            self.directory, "model-bw_dru.json"), "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights(
            os.path.join(self.directory, "model-bw_dru.h5"))

        self.json_file_tkdi = open(os.path.join(
            self.directory, "model-bw_tkdi.json"), "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights(
            os.path.join(self.directory, "model-bw_tkdi.h5"))

        self.json_file_smn = open(os.path.join(
            self.directory, "model-bw_smn.json"), "r")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights(
            os.path.join(self.directory, "model-bw_smn.h5"))
        ...
        #sef.panel3.place(x = 10,y=660)
        # slf.bt2.grid(row = 4, column = 1, columnspan = 1, padx = 10, pady = 10, sticky = tk.NW)
        self.bt3 = tk.Button(
            self.root, command=self.action3, height=0, width=0)
        self.bt3.place(x=625, y=890)
        # slf.bt3.grid(row = 4, column = 2, columnspan = 1, padx = 10, pady = 10, sticky = tk.NW)
        self.bt4 = tk.Button(
    ...
    def spellcheck(self, word):
        ...
        word = word.upper()
        if not all(c in ascii_uppercase for c in word):
            return []

        if not self.enchant_dict.check(word):
            predicts = self.spellcheck(self.word)
            return predicts
        return []
    ...
    def action_call(self):
        ...
        # self.photo1 = tk.PhotoImage(file="C:/Users/Vikash/Desktop/Sign-Language-to-Text-master/Pictures/vikash.jpg")
        ...
        # self.tx6.config(text="Vikash\n2006248", font=("Courier", 15, "bold"))

        # self.photo2 = tk.PhotoImage(file="/Pictures/ashray.png")
        ...
        # self.tx2.config(text="Ashray\n2006208", font=("Courier", 15, "bold"))

        # self.photo3 = tk.PhotoImage(file="/Pictures/himanshu.png")
        ...
        # self.tx3.config(text="Himanshu\n2006215", font=("Courier", 15, "bold"))

        # self.photo4 = tk.PhotoImage(file="/Pictures/mannu.png")
